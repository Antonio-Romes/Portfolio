...
export class ProjectsComponent {
  ...
  projects: ExtendedProject[] = [
    {
      ...
      description: 'Sistema completo de cadastro com validações em tempo real, paginação dinâmica, filtragem avançada e exportação para PDF/Excel.',
    ...
    },
    {
      ...
      description: 'Jogo de quebra-cabeça interativo com múltiplos níveis de dificuldade, seleção de imagens personalizadas e sistema de pontuação.',
    ...
    },
    {
      ...
      description: 'Aplicativo de gerenciamento de tarefas com interface moderna, categorização, filtros avançados e persistência de dados.',
    ...
    },
    {
      ...
      description: 'Jogo interativo de adivinhação com sistema de dicas inteligentes, diferentes níveis de dificuldade e ranking de pontuação.',
    ...
    },
    {
      ...
      description: 'API completa para e-commerce com autenticação JWT, gerenciamento de produtos, carrinho de compras e integração com pagamento.',
    ...
    },
    {
      ...
      description: 'Aplicativo mobile para delivery de comida com localização em tempo real, pagamento integrado e acompanhamento de pedidos.',
      technologies: ['React Native', 'TypeScript', 'Firebase', 'Google Maps API'],
      imageUrl: 'assets/img/mobile-placeholder.png',
  ...
  getDifficultyStars(difficulty: number): boolean[] {
    return Array(5).fill(false).map((_, index) => index < difficulty);
  }
